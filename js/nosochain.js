		...
		.then(data => {
			...
			data.forEach(item => {
				...
				row.innerHTML = `
					...
					<td class="priority-2">${item[2]}</td>
					<td class="priority-2">${item[3]}</td>
					<td class="priority-3">${item[4]}</td>
					<td class="priority-4">${item[5]}</td>
					<td class="priority-5">${item[6]}</td>
					<td class="priority-6">${item[7]}</td>
					<td class="priority-7">${item[8]}</td>
